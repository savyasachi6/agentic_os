...
The AgentOS .NET Tools Node employs a **Sidecar Pattern**. The core Python AI Agent (`AgentOSAgent`) makes HTTP requests to this node for any system interaction. This isolates high-risk system access from the untrusted LLM environment.
