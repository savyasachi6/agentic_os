...
- **Automation:** Use the provided [partition_manager.py](file:///c:/Users/savya/projects/agentic_os/memory/agent_memory/partition_manager.py) script.
...
3. Add to crontab (25th of every month at midnight):
   ...
   ```bash
   0 0 25 * * /usr/bin/python3 /path/to/memory/agent_memory/partition_manager.py
   ```
