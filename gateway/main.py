...
def cmd_run(args):
    ...
    async def run_main():
        ...
        try:
            # Initialize the stateful OrchestratorAgent
            print(f"Initializing OrchestratorAgent... (model={args.model})")
            agent = OrchestratorAgent(model_name=args.model, project_name=args.project)
