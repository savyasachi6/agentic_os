...
- **Implementation**: [agent_core/loop/coordinator.py](agent_core/loop/coordinator.py)
- **Tests**: [test_react.py](tests/core/test_react.py)
...
- **Implementation**: [llm_router/](llm_router/)
- **Tests**: [test_llm_router.py](tests/core/test_llm_router.py)
...
- **Implementation**: [agent_memory/vector_store.py](agent_memory/vector_store.py)
...
- **Implementation**: [agent_core/antigravity.py](agent_core/antigravity.py)
- **Tests**: [test_antigravity.py](tests/core/test_antigravity.py)
...
- **Implementation**: [agent_skills/indexer.py](agent_skills/indexer.py)
- **Tests**: [test_productivity_docs.py](tests/core/test_productivity_docs.py)
...
- **New Core Tools**: Register in `agent_core/tools/`.
- **New Specialized Skills**: Drop a `SKILL.md` into `skills/`.
